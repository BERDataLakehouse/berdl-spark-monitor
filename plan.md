...
class SparkMonitorPanel extends Panel {
  ...
  setVisibilityCallback(cb: (v: boolean) => void) { this._visibilityCallback = cb; }
  protected onAfterShow(msg: Message): void { super.onAfterShow(msg); this._visibilityCallback?.(true); }
  protected onAfterHide(msg: Message): void { super.onAfterHide(msg); this._visibilityCallback?.(false); }
}
```
